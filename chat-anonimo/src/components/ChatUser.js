...
class ChatUser extends Component {
  ...
  handleSubmit(event) {
    ...
    firebase.database().ref(`messages_${sessionStorage.getItem("nick")}/${this.state.id}/${message.id}`).set(message);
    firebase.database().ref(`messages_${this.state.id}/${sessionStorage.getItem("nick")}/${message.id}`).set(message);
      ...
      .on("value", (snapshot) => {
        ...
        if (currentUser !== null) {
          ...
          if (!validateNick) {
            ...
            this.changeMessagesChatCategory(sessionStorage.getItem("nick"),this.state.id,true);
            this.changeMessagesChatCategory(this.state.id,sessionStorage.getItem("nick"),false);
          }
        }
      });
  }
